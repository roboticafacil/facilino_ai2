...
public abstract class IntegerVariableBase  extends FacilinoActuatorSensorBase {
	protected int _value;

	/**
	 * Creates a new Facilino component.
	 */
	public IntegerVariableBase(ComponentContainer container) {
		super(container,"IntegerVariable",FacilinoBase.TYPE_INTEGER_VAR);
	_value=0;
	}
	...
	public void Received(int index, int value){
