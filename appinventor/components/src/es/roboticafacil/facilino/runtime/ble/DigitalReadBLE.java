...
import es.roboticafacil.facilino.runtime.ble.DigitalReadBase;
...
public class DigitalReadBLE  extends DigitalReadBase implements FacilinoBLESensor {
	/**
	 * Creates a new Facilino component.
	 */
	public DigitalReadBLE(ComponentContainer container) {
		super(container);
	}
