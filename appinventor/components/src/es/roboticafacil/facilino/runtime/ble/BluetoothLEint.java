...
import es.roboticafacil.facilino.runtime.ble.FacilinoBLEClient.BluetoothConnectionListener;
...
/**
 * The internal implementation of the FacilinoBLEClient component.
 *
...
final class BluetoothLEint {
  ...
  private abstract class BLEReadOperation<T> extends BLEOperation {
     ...
     */
    private final FacilinoBLEClient.BLEResponseHandler<T> handler;
    ...
    BLEReadOperation(Class<T> aClass, BluetoothGattCharacteristic characteristic, int type,
                     FacilinoBLEClient.BLEResponseHandler<T> handler, boolean notify) {
  ...
  private abstract class BLEWriteOperation<T> extends BLEOperation {
     ...
     */
    private FacilinoBLEClient.BLEResponseHandler<T> handler;
     ...
     */
    public void writeWithResponse(BluetoothGatt gatt, FacilinoBLEClient.BLEResponseHandler<T> handler) {
      this.handler = handler;
      write(gatt, BluetoothGattCharacteristic.WRITE_TYPE_NO_RESPONSE);
    }
  ...
  class BLEReadByteOperation extends BLEReadOperation<Integer> {
    ...
    BLEReadByteOperation(BluetoothGattCharacteristic characteristic, boolean signed,
                         FacilinoBLEClient.BLEResponseHandler<Integer> handler) {
     ...
     */
    BLEReadByteOperation(BluetoothGattCharacteristic characteristic, boolean signed,
                         FacilinoBLEClient.BLEResponseHandler<Integer> handler, boolean notify) {
  ...
  /*class BLEReadIntegerOperation extends BLEReadOperation<Long> {
    ...
    BLEReadIntegerOperation(BluetoothGattCharacteristic characteristic, boolean signed,
                            FacilinoBLEClient.BLEResponseHandler<Long> handler) {
      this(characteristic, signed, handler, false);
    }
    ...
    //
    BLEReadIntegerOperation(BluetoothGattCharacteristic characteristic, boolean signed,
                            FacilinoBLEClient.BLEResponseHandler<Long> handler, boolean notify) {
  ...
  /*class BLEReadFloatOperation extends BLEReadOperation<Float> {
    ...
    BLEReadFloatOperation(BluetoothGattCharacteristic characteristic, boolean shortFloat,
                          FacilinoBLEClient.BLEResponseHandler<Float> handler) {
    ...
    //
    BLEReadFloatOperation(BluetoothGattCharacteristic characteristic, boolean shortFloat,
                          FacilinoBLEClient.BLEResponseHandler<Float> handler, boolean notify) {
  ...
  /*class BLEReadStringOperation extends BLEReadOperation<String> {
    ...
    BLEReadStringOperation(BluetoothGattCharacteristic characteristic, boolean utf16,
                           FacilinoBLEClient.BLEResponseHandler<String> handler) {
    ...
    //
    BLEReadStringOperation(BluetoothGattCharacteristic characteristic, boolean utf16,
                           FacilinoBLEClient.BLEResponseHandler<String> handler, boolean notify) {
  ...
  static {
    ...
    errorMessages.put(ERROR_BLUETOOTH_LE_NOT_SUPPORTED,
        "FacilinoBLEClient is not supported on your phone's hardware!");
    errorMessages.put(ERROR_BLUETOOTH_LE_NOT_ENABLED,
        "FacilinoBLEClient is not enabled!");
    errorMessages.put(ERROR_API_LEVEL_TOO_LOW,
        "FacilinoBLEClient requires Android 5.0 or newer!");
  ...
  /**
   * FacilinoBLEClient Device Scanning and Connection Callbacks
   */
  ...
  /**
   * FacilinoBLEClient Device Status
   */
  ...
  BluetoothLEint(FacilinoBLEClient outer, final Activity activity, ComponentContainer container) {
  ...
  void ReadByteValues(final String serviceUuid, final String characteristicUuid,
                      final boolean signed,
                      final FacilinoBLEClient.BLEResponseHandler<Integer> callback) {
  ...
  void WriteShortValuesWithResponse(final String serviceUuid, final String characteristicUuid,
                                    final boolean signed, final List<Integer> values,
                                    final FacilinoBLEClient.BLEResponseHandler<Integer> handler) {
  ...
  void ReadIntegerValues(final String serviceUuid, final String characteristicUuid,
                         final boolean signed, final FacilinoBLEClient.BLEResponseHandler<Long> handler) {
  ...
  void RegisterForIntegerValues(final String serviceUuid, final String characteristicUuid,
                                final boolean signed,
                                final FacilinoBLEClient.BLEResponseHandler<Long> handler) {
  ...
  void ReadFloatValues(final String serviceUuid, final String characteristicUuid,
                       ...
                       final FacilinoBLEClient.BLEResponseHandler<Float> callback) {
      ...
      public Void action() {
        try {
          ...
          container.$form().dispatchErrorOccurredEvent(outer, "ReadString",
              ...
              "FacilinoBLEClient", UNKNOWN_CHAR_NAME);
        }
        return null;
      }
    }.run();
  ...
  void RegisterForStringValues(final String serviceUuid, final String characteristicUuid,
                               final boolean utf16,
                               final FacilinoBLEClient.BLEResponseHandler<String> handler) {
  ...
  void UnregisterForValues(final String serviceUuid, final String characteristicUuid,
                           final FacilinoBLEClient.BLEResponseHandler<?> handler) {
  ...
  List<String> DeviceList() {
    deviceInfoList = new ArrayList<String>();
    if (!mLeDevices.isEmpty()) {
  ...
  YailList GetCharacteristicsForService(String serviceUuid) {
    ...
    try {
      ...
      Log.e(LOG_TAG, "Exception while looking up FacilinoBLEClient service", e);
      throw new RuntimeException("Exception while looking up FacilinoBLEClient service: " +
          e.getMessage(), e);
    }
    ...
    activity.runOnUiThread(new Runnable() {
      ...
      public void run() {
        container.$form().dispatchErrorOccurredEvent(BluetoothLEint.this.outer, functionName,
            ErrorMessages.ERROR_EXTENSION_ERROR, errorNumber, "FacilinoBLEClient", errorMessage);
      }
    });
  }
