...
import es.roboticafacil.facilino.runtime.bluetooth.SonarBase;
...
public class SonarBluetooth extends SonarBase implements FacilinoBluetoothSensor {
  /**
   * Creates a new Facilino component.
   */
  public SonarBluetooth(ComponentContainer container) {
	  super(container);
  }
  ...
  private YailList readTelegram() {
	  ...
	  bytes[0]='@';
	  bytes[1]=FacilinoBluetoothClient.CMD_SONAR_READ_REQ;
	  bytes[2]=2;
  ...
  public void dispatchData(byte cmd,byte[] data){
	  if (cmd==FacilinoBluetoothClient.CMD_SONAR_READ_RESP){
