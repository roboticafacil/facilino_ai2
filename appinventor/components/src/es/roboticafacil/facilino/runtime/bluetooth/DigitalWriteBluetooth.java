...
import es.roboticafacil.facilino.runtime.bluetooth.DigitalWriteBase;
...
public class DigitalWriteBluetooth  extends DigitalWriteBase implements FacilinoBluetoothActuator {
  /**
   * Creates a new Facilino component.
   */
  public DigitalWriteBluetooth(ComponentContainer container) {
    super(container);
  }
  ...
  public void Toggle() {
	  _value=!_value;
	  if (_facilino instanceof FacilinoBluetoothClient)
		((FacilinoBluetoothClient)_facilino).SendBytes(setTelegram(_value));
  ...
  private YailList setTelegram(boolean value)
  {
	  ...
	  bytes[0]='@';
	  bytes[1]=FacilinoBluetoothClient.CMD_DIGITAL_WRITE;
	  bytes[2]=2;
	  bytes[3]=(byte)_pin;
