...
public abstract class FacilinoBluetoothConnectionBase extends FacilinoBase
  ...
  private final List<FacilinoBluetoothConnectionListener> bluetoothConnectionListeners =
      new ArrayList<FacilinoBluetoothConnectionListener>();
   ...
   */
  protected FacilinoBluetoothConnectionBase(ComponentContainer container, String logTag) {
    this(container.$form(), logTag);
    form.registerForOnDestroy(this);
  }

  private FacilinoBluetoothConnectionBase(Form form, String logTag) {
    super(form,"FacilinoBluetooth",FacilinoBase.TYPE_MANAGER_BLUETOOTH);
    this.logTag = logTag;
   ...
   */
  void addBluetoothConnectionListener(FacilinoBluetoothConnectionListener listener) {
   ...
   */
  void removeBluetoothConnectionListener(FacilinoBluetoothConnectionListener listener) {
    bluetoothConnectionListeners.remove(listener);
  }

  private void fireAfterConnectEvent() {
    for (FacilinoBluetoothConnectionListener listener : bluetoothConnectionListeners) {
